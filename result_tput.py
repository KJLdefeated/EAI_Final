...
def evaluate_ppl(model, tokenizer, device="cuda:0"):
    ...
    for i in tqdm(range(nsamples), desc="Evaluating..."):
        ...
        with torch.no_grad():
            ...
            logps = [p[id].logprob for p, id in zip(generated_info.prompt_logprobs[1:-1], generated_info.prompt_token_ids[1:-1])]
            #print(len(logps))
...
def main():
    ...
    model_name = "BensonW/EAI-Final-LoRA-awq"
    ...
    #model.eval()
    tokenizer = model.get_tokenizer(model_name)
